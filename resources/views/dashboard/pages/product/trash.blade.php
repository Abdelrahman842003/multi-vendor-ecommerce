        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="col-auto">
                        <a href="{{ route('dashboard.product.index') }}" class="btn btn-primary-gradient">Back</a>
                    </div>
                    <form action="{{ route('dashboard.product.trash') }}" method="GET">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover mb-0 text-md-nowrap">
                        ...
                        <tbody>
                        @forelse($productTrash as $product)
                            <tr>
                                <td>
                                    {{$product->store->name}}
                                </td>
                                ...
                                <td>
                                    <form action="{{ route('dashboard.product.restore', $product->id) }}" method="POST" style="display: inline-block;">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form action="{{ route('dashboard.product.forceDelete', $product->id) }}" method="POST" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
