...
<head>
    ...
    <link rel="stylesheet" href="{{asset('frontend/css/LineIcons.3.0.css')}}"/>
                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        <li>
                                            ...
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img
                                                        src="{{asset('frontend/images/header/cart-items/item1.jpg')}}"
                                                        alt="#"></a>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img
                                                        src="{{asset('frontend/images/header/cart-items/item2.jpg')}}"
                                                        alt="#"></a>
                                            </div>
                                            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="{{asset('frontend/images/logo/white-logo.svg')}}" alt="#">
                            </a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-12">
                        <div class="payment-gateway">
                            <span>We Accept:</span>
                            <img src="{{asset('frontend/images/footer/credit-cards-footer.png')}}" alt="#">
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <div class="copyright">
